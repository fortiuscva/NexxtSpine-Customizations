            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Comment Line"; "Sales Comment Line")
                    {
                        ...
                        column(LineNoSalesCommentLineHdr; "Sales Comment Line"."Line No.")
                        {

                        }
                        column(CommentSalesCommentLineHdr; "Sales Comment Line".Comment)
                        {
                    ...
                    dataitem(SalesCrMemoLine; "Integer")
                    {
                        ...
                        column(LineNoTempSalesCrMemoLine; TempSalesCrMemoLine."Line No.")
                        {
